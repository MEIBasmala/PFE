  ...
  return (
    <div className="warm-bg">
      ...
      {/* ═══════════════════════════════════════
          HERO (no changes) 
      ═══════════════════════════════════════ */}
      <section className="relative overflow-hidden flex flex-col items-center justify-center text-center px-[6%] pt-20 pb-12 md:pt-24 md:pb-16 lg:pt-28 lg:pb-20 min-h-[calc(100dvh-70px)] z-[1]">
        {/* floating foods */}
        ...
        <div className="relative z-[1]">
          <h1 className="font-syne text-[clamp(2rem,5vw,4rem)] font-[800] leading-[1.05] tracking-[-2px] mb-6 animate-fadeUp-1">
            We built{' '}
          ...
          <p className="text-base md:text-lg text-[hsl(var(--text-m))] max-w-[580px] mx-auto leading-[1.7] mb-8 md:mb-10 font-light animate-fadeUp-2 px-2">
          ...
          <div className="flex gap-3 md:gap-4 justify-center flex-wrap animate-fadeUp-3 px-4">
      ...
      ═══════════════════════════════════════ */}
      <section className="py-16 md:py-24 px-[6%] bg-[hsl(var(--pure-white))] relative overflow-hidden">
        <div
        ...
        />
        <div className="relative z-[1] max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-20 items-center">
          ...
          <div className="relative reveal-left">
            <Card className="bg-[hsl(var(--cream-bg))] border-[hsl(var(--gray-line))] rounded-lg shadow-md">
              <CardContent className="p-6 md:p-10">
                ...
                <div className="font-syne text-[clamp(1.1rem,2.5vw,1.4rem)] font-bold leading-[1.4]">
                  "Snap a photo.<br />
            ...
            <div className="absolute -top-5 right-5 bg-[hsl(var(--pure-white))] border border-[hsl(var(--gray-line))] rounded-[14px] px-5 py-3 text-[0.78rem] font-semibold shadow-kl-m animate-float flex items-center gap-2 max-lg:hidden">
              <span className="w-2 h-2 rounded-full bg-[hsl(var(--green-dark))]" /> YOLOv8 Food Detection
            </div>
            <div className="absolute -bottom-5 left-5 bg-[hsl(var(--pure-white))] border border-[hsl(var(--gray-line))] rounded-[14px] px-5 py-3 text-[0.78rem] font-semibold shadow-kl-m animate-float-delay flex items-center gap-2 max-lg:hidden">
          ...
          <div className="reveal-right">
            ...
            <h2 className="font-syne text-[clamp(1.5rem,3vw,2.5rem)] font-[800] tracking-[-1px] leading-[1.15] mb-4 md:mb-5 px-2">
              Nutrition intelligence, for everyone.
            </h2>
            <p className="text-[hsl(var(--text-m))] leading-[1.75] text-[0.85rem] md:text-[0.95rem] mb-6">
            ...
            <div className="flex flex-col gap-3 mt-6">
              {missionValues.map((v, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-[0.85rem] md:text-[0.9rem] block">{v.title}</strong>
                    <span className="text-[0.78rem] md:text-[0.82rem] text-[hsl(var(--text-m))]">{v.desc}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      >
        ...
        <div className="relative z-[1] max-w-[900px] mx-auto text-center">
          <span className="text-[0.7rem] md:text-[0.75rem] font-semibold tracking-[2px] uppercase text-[hsl(var(--green))] mb-3 md:mb-4 block">
            <Sparkles size={12} className="inline-block align-middle mr-1" /> The Name
          </span>
          <h2 className="font-syne text-[clamp(1.6rem,4vw,3.2rem)] font-[800] tracking-[-1px] leading-[1.1] mb-4 md:mb-6 text-white reveal px-2">
            What does{' '}
          ...
          <div
            className="grid grid-cols-2 gap-8 mt-10 text-left max-md:grid-cols-1 rounded-lg reveal p-6 md:p-12"
            style={{
          ...
          >
            ...
            >
              <div className="font-syne text-[clamp(1.8rem,5vw,2.8rem)] font-[800] text-[hsl(var(--green))] mb-1">Khabir</div>
              <div className="text-[0.7rem] md:text-[0.75rem] font-semibold tracking-[2px] uppercase text-white/50 mb-2 md:mb-3">
                Arabic — خبير
              </div>
              <p className="text-[0.8rem] md:text-[0.9rem] text-white/85 leading-[1.65]">
            ...
            >
              <div className="font-syne text-[clamp(1.8rem,5vw,2.8rem)] font-[800] text-[hsl(var(--orange))] mb-1">Lens</div>
              <div className="text-[0.7rem] md:text-[0.75rem] font-semibold tracking-[2px] uppercase text-white/50 mb-2 md:mb-3">
                English — the AI eye
              </div>
              <p className="text-[0.8rem] md:text-[0.9rem] text-white/85 leading-[1.65]">
          ...
          <p className="mt-8 md:mt-10 text-sm md:text-base text-white/70 leading-[1.7] font-light max-w-[640px] mx-auto reveal px-2">
      ...
      ═══════════════════════════════════════ */}
      <section id="team" className="py-16 md:py-24 px-[6%] bg-[hsl(var(--pure-white))]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16 reveal">
            <span className="text-[0.7rem] md:text-[0.75rem] font-semibold tracking-[2px] uppercase text-[hsl(var(--green-dark))] mb-3 md:mb-4 block">
              <Sparkles size={12} className="inline-block align-middle mr-1" /> Our Team
            </span>
            <h2 className="font-syne text-[clamp(1.6rem,4vw,3rem)] font-[800] tracking-[-1px] leading-[1.1] mb-3 md:mb-4 px-2">
              Built by people who care.
            </h2>
            <p className="text-[hsl(var(--text-m))] text-sm md:text-base max-w-[600px] mx-auto leading-[1.7] font-light px-2">
            ...
            {team.map((t, i) => (
              ...
              >
                <CardContent className="p-5 md:p-8">
                  <div
                    className={`w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br ${t.gradient} border-[3px] border-[hsl(var(--pure-white))] shadow-[0_4px_16px_rgba(0,0,0,0.08)] flex items-center justify-center mx-auto mb-5 font-syne text-[1.8rem] font-[800] text-[hsl(var(--green-dark))] transition-transform group-hover:scale-[1.08] group-hover:rotate-[4deg]`}
                  >
                    {t.avatar}
                  </div>
                  <div className="font-syne text-base md:text-[1.1rem] font-bold mb-1">{t.name}</div>
                  <div className="text-[0.72rem] md:text-[0.78rem] font-semibold text-[hsl(var(--orange))] uppercase tracking-[1px] mb-3">
                    {t.role}
                  </div>
                  <p className="text-[0.78rem] md:text-[0.83rem] text-[hsl(var(--text-m))] leading-[1.6] mb-5">{t.bio}</p>
                  <div className="flex flex-wrap gap-1.5 justify-center">
                    {t.tags.map(tag => (
                      <Badge
                        key={tag}
                        variant="secondary"
                        className="text-[0.6rem] md:text-[0.65rem] font-semibold px-2 md:px-3 py-0.5 rounded-full bg-[hsl(var(--green-light))] text-[hsl(var(--green-dark))] hover:bg-[hsl(var(--green-light))]"
                      >
                        {tag}
                      </Badge>
                    ))}
        ...
        <div className="relative z-[1] max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-14 relative">
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[hsl(var(--green-light))] border-[1.5px] border-[hsl(var(--green))] flex items-center justify-center font-syne text-lg md:text-xl font-[800] text-[hsl(var(--green-dark))] mx-auto mb-5 transition-all group-hover:scale-[1.12] group-hover:shadow-[0_8px_24px_rgba(194,230,110,0.5)]">
                  {s.num}
                </div>
                <div className="font-syne text-sm md:text-base font-bold mb-2">{s.title}</div>
                <div className="text-[0.8rem] md:text-[0.85rem] text-[hsl(var(--text-m))] leading-relaxed">{s.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      ═══════════════════════════════════════ */}
      <section className="py-16 md:py-24 px-[6%] bg-[hsl(var(--cream-bg))]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16 reveal">
            <span className="text-[0.7rem] md:text-[0.75rem] font-semibold tracking-[2px] uppercase text-[hsl(var(--green-dark))] mb-3 md:mb-4 block">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {techStack.map((t, i) => (
              ...
              >
                <CardContent className="p-5 md:p-8 flex gap-4 md:gap-5 items-start">
                  <div
                    className={`w-10 h-10 md:w-[52px] md:h-[52px] rounded-xl flex items-center justify-center flex-shrink-0 ${t.colorClass} transition-transform group-hover:rotate-[-8deg] group-hover:scale-110`}
                  >
                    <t.icon size={22} className={t.iconColor} />
                  </div>
                  <div>
                    <h3 className="font-syne text-sm md:text-base font-bold mb-1.5">{t.title}</h3>
                    <p className="text-[0.78rem] md:text-[0.83rem] text-[hsl(var(--text-m))] leading-[1.6] mb-3">{t.desc}</p>
                    <div className="flex flex-wrap gap-1.5">
                      {t.pills.map(p => (
                        <Badge
                          key={p}
                          variant="outline"
                          className="text-[0.6rem] md:text-[0.65rem] font-semibold px-2 md:px-3 py-0.5 rounded-full bg-[hsl(var(--cream-bg))] border-[hsl(var(--gray-line))] text-[hsl(var(--text-m))]"
                        >
                          {p}
                        </Badge>
                      ))}
      ...
      <section className="relative py-16 md:py-24 px-[6%] overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-syne text-[clamp(1.8rem,4vw,3.5rem)] font-extrabold tracking-tight mb-4 text-[hsl(var(--text-dark))]">            Ready to eat smarter?
          </h2>

          <p className="text-[hsl(var(--text-m))] text-sm md:text-base max-w-2xl mx-auto leading-relaxed mb-8 md:mb-10 px-2">
